...
public class KeyPress implements UpdateListener {
    ...
    public void update(EventBean[] newEvents, EventBean[] oldEvents) {
        for (EventBean event : newEvents) {
            ...
            /*
            //TODO Push the Robot manipulation for the emulation into another system that is continually updated..
            //We would be able to better control the keyboard emulation that way. This listener would just be for
            //sending the other system updates on events that have occurred.
            switch(_type) {
                case KEY_DOWN_UP:
