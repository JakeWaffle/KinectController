 ...
 */
public interface PersistentReaction {
    /**
     * This identifier is used to distinguish the specific persistent reaction, in case it needs to be stopped
     * externally.
     * @return The identifier for the reaction.
     */
    String getId();
     ...
     * is only concerned with triggering the reaction and then getting the trigger's response.
     * @return A boolean specifying whether or not the reaction should continue or not.
     */
    boolean trigger();
}
